    ...
    <fieldset disabled={isSaving}>
      ...
      <div className="row mb-3">
        <div className="col-md-6">
          ...
          <input
            ...
            className="form-control"
            id="edit-feedstock"
            name="feedstock" // Matches SupabaseFacilityFormData key
        ...
        <div className="col-md-6">
          ...
          <input
            ...
            className="form-control"
            id="edit-product"
            name="product" // Matches SupabaseFacilityFormData key
      ...
      <div className="mb-3">
        ...
        <textarea
          ...
          name="technology_description" // UPDATED: Matches SupabaseFacilityFormData key
